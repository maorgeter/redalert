...
exports.zonesRoutes = zonesRoutes;
async function zonesRoutes(fastify, opts) {
    ...
    fastify.get('/api/zones', async (_req, reply) => {
        ...
        return reply.send({
            ...
            count: zones.length,
            disclaimer: 'ESTIMATED ZONES: These polygons are derived visualizations from public alert events. ' +
